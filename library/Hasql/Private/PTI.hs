...
pg_database     = mkPTI LibPQ.Binary 1248 Nothing
pg_lsn          = mkPTI LibPQ.Binary 3220 (Just 3221)
pg_type         = mkPTI LibPQ.Binary 71   Nothing
...
regrole         = mkPTI LibPQ.Binary 4096 (Just 4097)
